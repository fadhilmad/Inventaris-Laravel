    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-start">
                    ...
                    <li>
                        ...
                        <div class="collapse show" id="rli">
                            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                ...
                                <li><a href="{{ route('tu.tambahData') }}" class="nav-link unstyled text-dark navbar-active" aria-current="page">Tambah Data</a></li>
                            </ul>
                        </div>
                    </li>
                    <li>
            ...
            <div class="container-fluid m-5">
                <div class="card">
                    <h3 class="text-center m-3">Tambah Data Inventaris {{ Auth::user()->unit_kerja }}</h3>
                    <hr>
                    <div class="card-body">
                        <form method="post" action="{{ route('tu.prosTambahData') }}">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-capitalize" name="tahun" id="datepicker" />
                                @error('tahun')
                            ...
                            <div class="mb-3">
                                <label for="keterangan_inventaris" class="form-label">Kondisi</label>
                                <input name="keterangan_inventaris" list="kondisi" value="{{ old('keterangan_inventaris') }}" class="form-control text-capitalize @error('keterangan_inventaris') is-invalid @enderror" type="text" aria-label="default input example" autocomplete="off" required>
                                <datalist id="kondisi">
                                    <option value="Baik">
                                    <option value="Buruk">
                                </datalist>
                                @error('keterangan_inventaris')
                                <div id="keterangan_inventaris" class="invalid-feedback">
                                    {{ $message }}
                                </div>
                                @enderror
                            </div>
