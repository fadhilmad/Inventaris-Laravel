                        ...
                        <li>
                            ...
                            <div class="collapse show" id="rli">
                                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                    ...
                                    <li><a href="{{ route('pplp.laporanBiro') }}" class="nav-link unstyled  text-dark navbar-active " aria-current="page">Biro - <span class="fw-bold">Detail</span></a></li>
                                </ul>
                            </div>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <div class="collapse show" id="rli">
                                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                    ...
                                    <li><a href="{{ route('inventaris.laporanBiro') }}" class="nav-link unstyled unstyled text-dark navbar-active " aria-current="page">Biro - <span class="fw-bold">Detail</span></a></li>
                                </ul>
                            </div>
                        </li>
                        <li>
