    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-start">
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    ...
                    @elseif(Auth::user()->hasRole('inventaris'))
                        ...
                        <li>
                            ...
                            <div class="collapse show" id="rli">
                                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                    <li><a href="{{ route('inventaris.laporanProdi') }}" class="nav-link unstyled text-dark navbar-active " aria-current="page">Program Studi</a></li>
            ...
            <div class="container-fluid m-5">
                <div class="card">
                    <h3 class="text-center m-3">Laporan Inventaris Program Studi</h3>
                    <hr>
                    <div class="card-body">
