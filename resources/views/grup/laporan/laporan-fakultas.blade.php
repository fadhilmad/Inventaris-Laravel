    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-start">
                        ...
                        <li>
                            ...
                            <div class="collapse show" id="rli">
                                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                    ...
                                    <li><a href="{{ route('pplp.laporanFakultas') }}" class="nav-link unstyled  text-dark navbar-active " aria-current="page">Fakultas</a></li>
                        ...
                        <li>
                            ...
                            <div class="collapse show" id="rli">
                                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                    ...
                                    <li><a href="{{ route('inventaris.laporanFakultas') }}" class="nav-link unstyled text-dark navbar-active " aria-current="page">Fakultas</a></li>
            ...
            <div class="container-fluid m-5">
                <div class="card">
                    <h3 class="text-center m-3">Laporan Inventaris Fakultas</h3>
                    <hr>
                    <div class="card-body">
                        <table id="table1" class="table table-striped display" style="width:100%">
                            ...
                            @foreach( $data as $d )
                                <tr class="text-center">
                                    ...
                                    <td>{{ $d->unit_kerja }}</td>
                                    @if(Auth::user()->hasRole('pplp'))
                                        <td><a href="/pplp/laporan/fakultas/{{ $d->unit_kerja }}/detail"><button class="btn btn-sm btn-success">Detail</button></a></td>
                                    @elseif(Auth::user()->hasRole('inventaris'))
                                        <td><a href="/inventaris/laporan/fakultas/{{ $d->unit_kerja }}/detail"><button class="btn btn-sm btn-success">Detail</button></a></td>
                                    @endif
                                </tr>
                            @endforeach
                            </tbody>
