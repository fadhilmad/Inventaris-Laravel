                        ...
                        <table id="table1" class="table table-striped display" style="width:100%">
                            ...
                            @foreach( $data as $d )
                                <tr class="text-center">
                                    ...
                                    <td>{{ $d->unit_kerja }}</td>
                                    @if(Auth::user()->hasRole('pplp'))
                                    <td><a href="/pplp/laporan/biro/{{ $d->unit_kerja }}/detail"><button class="btn btn-sm btn-success">Detail</button></a></td>
                                    @elseif(Auth::user()->hasRole('inventaris'))
                                    <td><a href="/inventaris/laporan/biro/{{ $d->unit_kerja }}/detail"><button class="btn btn-sm btn-success">Detail</button></a></td>
                                    @endif
                                </tr>
                            @endforeach
                            </tbody>
