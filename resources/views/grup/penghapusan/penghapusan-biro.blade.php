                        ...
                        <li>
                            ...
                            <div class="collapse show" id="rpei">
                                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                    ...
                                    <li><a href="{{ route('pplp.penghapusanBiro') }}" class="nav-link unstyled text-dark navbar-active " aria-current="page">Biro & Unit</a></li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li>
                            ...
                            <div class="collapse show" id="rpei">
                                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                    ...
                                    <li><a href="{{ route('inventaris.penghapusanBiro') }}" class="nav-link unstyled  text-dark navbar-active " aria-current="page">Biro & Unit</a></li>
                                </ul>
                            </div>
                        </li>
                    @endif
                        ...
                        <table id="table1" class="table table-striped display" style="width:100%">
                            ...
                            @foreach( $data as $d )
                                <tr class="text-center">
                                    ...
                                    <td>{{ $d->unit_kerja }}</td>
                                    @if(Auth::user()->hasRole('pplp'))
                                        <td><a href="/pplp/penghapusan/biro/{{ $d->unit_kerja }}/detail"><button class="btn btn-sm btn-success">Detail</button></a></td>
                                    @elseif(Auth::user()->hasRole('inventaris'))
                                        <td><a href="/inventaris/penghapusan/biro/{{ $d->unit_kerja }}/detail"><button class="btn btn-sm btn-success">Detail</button></a></td>
                                    @endif
                                </tr>
                            @endforeach
                            </tbody>
