                    ...
                    <li>
                        ...
                        <div class="collapse show" id="rpei">
                            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                ...
                                <li><a href="{{ route('wr.penghapusanBiro') }}" class="nav-link unstyled  text-dark navbar-active " aria-current="page">Biro & Unit - <span class="fw-bold">Detail</span></a></li>
                            </ul>
                        </div>
                    </li>
                </ul>
