    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-start">
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    ...
                    <li>
                        ...
                        <div class="collapse show" id="rpei">
                            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                <li><a href="{{ route('wr.penghapusanProdi') }}" class="nav-link unstyled text-dark navbar-active " aria-current="page">Program Studi</a></li>
            ...
            <div class="container-fluid m-5">
                <div class="card">
                    <h3 class="text-center m-3">Penghapusan Inventaris Prodi</h3>
                    <hr>
                    <div class="card-body">
