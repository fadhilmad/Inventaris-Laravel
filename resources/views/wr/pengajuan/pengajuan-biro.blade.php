    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-start">
                    ...
                    <li>
                        ...
                        <div class="collapse show" id="rpi">
                            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                ...
                                <li><a href="{{ route('wr.pengajuanBiro') }}" class="nav-link unstyled text-dark navbar-active " aria-current="page">Biro & Unit</a></li>
                            </ul>
                        </div>
                    </li>
                    <li>
            ...
            <div class="container-fluid m-5">
                <div class="card">
                    <h3 class="text-center m-3">Pengajuan Inventaris Biro & Unit</h3>
                    <hr>
                    <div class="card-body">
                        <table id="table1" class="table table-striped display " style="width:100%">
                            ...
                            @foreach( $daftar as $d )
                                <tr class="text-center">
                                    ...
                                    <td>{{ $d->unit_kerja }}</td>
                                    <td><a href="/wr/pengajuan/biro/{{ $d->unit_kerja }}/detail"><button class="btn btn-sm btn-success">Detail</button></a></td>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
