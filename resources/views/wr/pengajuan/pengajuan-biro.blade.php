    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-start">
                    ...
                    <li>
                        ...
                        <div class="collapse show" id="rpi">
                            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                ...
                                <li><a href="{{ route('wr.pengajuanBiro') }}" class="nav-link unstyled text-dark navbar-active " aria-current="page">Biro</a></li>
                            </ul>
                        </div>
                    </li>
                    <li>
            ...
            <div class="container-fluid m-5">
                <div class="card">
                    <h3 class="text-center m-3">Pengajuan Inventaris Biro</h3>
                    <hr>
                    <div class="card-body">
