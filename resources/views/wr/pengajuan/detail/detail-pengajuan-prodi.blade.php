    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-start">
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    ...
                    <li>
                        ...
                        <div class="collapse show" id="rpi">
                            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                <li><a href="{{ route('wr.pengajuanProdi') }}" class="nav-link unstyled text-dark navbar-active " aria-current="page">Program Studi - <span class="fw-bold">Detail</span></a></li>
            ...
            <div class="container-fluid m-5">
                <a href="{{ route('wr.pengajuanProdi') }}">
                        ...
                        <table id="table3" class="table table-striped display " style="width:100%">
                            ...
                            @foreach( $data as $v )
                                <tr class="text-center align-middle">
                                    ...
                                    <td><input data-id="{{ $v->id }}" id="toggle3" class="toggle-class" type="checkbox" data-onstyle="success" data-offstyle="danger" data-toggle="toggle" data-on="Valid" data-off="Tidak Valid" {{ $v->validasi_wr ? 'checked' : '' }}></td>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
