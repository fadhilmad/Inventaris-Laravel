                    ...
                    <li>
                        ...
                        <div class="collapse show" id="rpi">
                            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                ...
                                <li><a href="{{ route('admin.rekapPengajuanFakultas') }}" class="nav-link unstyled text-dark navbar-active" aria-current="page">Fakultas - <span class="fw-bold">Detail</span></a></li>
